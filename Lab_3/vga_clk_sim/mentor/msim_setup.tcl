...
# ----------------------------------------
# If vga_clk is one of several IP cores in your
...
# ----------------------------------------
# ACDS 16.0 211 win32 2017.03.27.01:43:43
...
if ![info exists QUARTUS_INSTALL_DIR] { 
  set QUARTUS_INSTALL_DIR "C:/altera_lite/16.0/quartus/"
}
...
alias com {
  echo "\[exec\] com"
  eval  vcom $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/vga_clk.vho"
}
